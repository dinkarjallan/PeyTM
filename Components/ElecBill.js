        ...
        <>
            ...
            <View style={styles.pageContainer}>
                {/* <TextInput
                    ...
                    placeholder={`${icon} Select State`} /> */}
                <View style={styles.pickerContainer}>
                    <Text style={styles.pickerHeading}>Select State:</Text>
                    <RNPickerSelect
                        onValueChange={(value) => { }}
                        items={[
                            { label: 'PSPCL', value: 'PSPCL' },
                            { label: 'Delhi Electrical Board', value: 'Delhi Electrical Board' },
                            { label: 'Punjab Power', value: 'Punjab Power' },
                            { label: 'Kolkata Night riders', value: 'Kolkata Night riders' },
                            { label: 'PSPCL', value: 'PSPCL' },
                            { label: 'Delhi Electrical Board', value: 'Delhi Electrical Board' },
                            { label: 'Punjab Power', value: 'Punjab Power' },
                            { label: 'Kolkata Night riders', value: 'Kolkata Night riders' },
